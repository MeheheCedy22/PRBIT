...
#let ieee(
  ...
  figure-supplement: [Obrázok č.],
  // table-supplement: [Tabuľka č.],
  ...
  // added following LOC (Line of Code)
  ...
  show figure: fig => {
    let prefix = (
      ...
      else if fig.kind == image [Obrázok č.]
      else [#fig.supplement]
    )
  ...
  set std.bibliography(title: text(10pt)[Literatúra], style: "ieee")
