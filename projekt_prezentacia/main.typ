...
// PRBIT: prezentacia co ma obsahovat hlavne, ale inak id podla dokumentu a dat tam veci co som robil a primarne experimenty
// experimenty
// obrazky
// zhodnotenie
...
// ukazka composera (na 2 alebo viacej stlpcov v jednom slide)
// = Complex Layouts
// == Complex Layouts 2
