...
\author{\IEEEauthorblockN{1\textsuperscript{st} Marek Čederle}
\IEEEauthorblockA{\textit{Fakulta informatiky a informačných technológií} \\
\textit{Slovenská Technická Univerzita}\\
...
\section{Zoznam základných použitých prameňov}

\section{Všetkému, čo považujete za dôležité}
